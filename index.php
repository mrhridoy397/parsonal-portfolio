        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
          <div class="portfolio-wrap">
            ...
            <div class="portfolio-links">
              <a href="<?php echo $value['image']; ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 1"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.php?gid=<?php echo $value['id']; ?>" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
        </div>
        <?php }?>
