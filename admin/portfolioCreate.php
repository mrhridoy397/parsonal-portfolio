            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="portfolioIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-users-cog fa-sm text-white-50"></i> All Portfolio</a>
                    </div>
                        ...
                        <div class="col-md-7 offset-md-2">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Create at Portfolio</h6>
                                </div>
                                <div class="card-body">
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" class="form-signin" >
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                        <div class="form-group">
                                                <label for="categories_name" >Categoris Name</label>
                                                <input type="text" id="categories_name" class="form-control form-control-user" placeholder="Categoris Name" name="categories_name" required autofocus value="<?php if (isset($_POST['categories_name'])) echo $_POST['categories_name']; ?>">
                                                <?php if (isset($Response['categories_name']) && !empty($Response['categories_name'])) : ?>
                                                    <small class="text-danger"><?php echo $Response['categories_name']; ?></small>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 text-center">
                                            ...
                                            <a href="portfolioIndex.php" class="btn btn-md btn-primary btn-danger">Cencle</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
