                                    ...
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin" enctype="multipart/form-data">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="dob" class="form-control form-control-user" placeholder=" Enter Dob " name="dob" required autofocus value="<?php if (isset($_POST['dob'])){ echo $_POST['dob'];} else { echo $data['dob'];} ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="age" class="form-control form-control-user" placeholder=" Enter Age " name="age" required autofocus value="<?php if (isset($_POST['age'])){ echo $_POST['age'];} else { echo $data['age'];} ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="website" class="form-control form-control-user" placeholder=" Enter website URL " name="website" required autofocus value="<?php if (isset($_POST['website'])){ echo $_POST['website'];} else { echo $data['website'];} ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="degree" class="form-control form-control-user" placeholder=" Enter Degree " name="degree" required autofocus value="<?php if (isset($_POST['degree'])){ echo $_POST['degree'];} else { echo $data['degree'];} ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="phone" class="form-control form-control-user" placeholder=" Enter Phone " name="phone" required autofocus value="<?php if (isset($_POST['phone'])){ echo $_POST['phone'];} else { echo $data['phone'];} ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input type="email" id="email" class="form-control form-control-user" placeholder=" Enter Email " name="email" required autofocus value="<?php if (isset($_POST['email'])){ echo $_POST['email'];} else { echo $data['email'];} ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="city" class="form-control form-control-user" placeholder=" Enter City " name="city" required autofocus value="<?php if (isset($_POST['city'])){ echo $_POST['city'];} else { echo $data['city'];} ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="freelance" class="form-control form-control-user" placeholder=" Enter Freelance " name="freelance" required autofocus value="<?php if (isset($_POST['freelance'])){ echo $_POST['freelance'];} else { echo $data['freelance'];} ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control form-control-user" type="url" name="link1" id="link1" placeholder="https://" required autofocus value="<?php if (isset($_POST['link1'])){ echo $_POST['link1'];} else { echo $data['link1'];} ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control form-control-user" type="url" name="link2" id="link2" placeholder="https://" required autofocus value="<?php if (isset($_POST['link2'])){ echo $_POST['link2'];} else { echo $data['link2'];} ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control form-control-user" type="url" name="link3" id="link3" placeholder="https://" required autofocus value="<?php if (isset($_POST['link3'])){ echo $_POST['link3'];} else { echo $data['link3'];} ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control form-control-user" type="url" name="link4" id="link4" placeholder="https://" required autofocus value="<?php if (isset($_POST['link4'])){ echo $_POST['link4'];} else { echo $data['link4'];} ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control form-control-user" type="url" name="link5" id="link5" placeholder="https://" required autofocus value="<?php if (isset($_POST['link5'])){ echo $_POST['link5'];} else { echo $data['link5'];} ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                               ...
                                               <textarea name="about" id="about" cols="30" rows="10"><?php if (isset($_POST['about'])){ echo $_POST['about'];} else { echo $data['about'];} ?></textarea>
