...
$data = $services->servicesedit($_REQUEST['id']);
if (isset($_REQUEST['submit']) && count($_REQUEST) > 1) $Response = $services->servicesUpdate($_REQUEST);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="ServicesIndex.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-users-cog fa-sm text-white-50"></i> All <?php echo $active; ?></a>
                    </div>
                        ...
                        <div class="col-md-8 offset-md-2">
                            <div class="card shadow mb-4">
                                    ...
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="Description" class="form-control form-control-user" placeholder=" Enter Description" name="Description" required autofocus value="<?php if (isset($_POST['Description'])) {  echo $_POST['Description'];    } else {    echo $data['Description']; } ?>">
                                ...
                                <div class="form-group text-center mt-5">
                                    ...
                                    <a href="ServicesIndex.php" class="btn btn-danger">Cancle</a>
                                </div>
                                </form>
                            </div>
                        </div>
